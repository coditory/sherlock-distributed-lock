...
```gradle
dependencies {
  compile "com.coditory.sherlock:sherlock-mongo-sync:0.2.1"
}
```
...
```gradle
dependencies {
  compile "com.coditory.sherlock:sherlock-mongo-reactive:0.2.1"
  compile "com.coditory.sherlock:sherlock-api-reactor:0.2.1"
  // for RxJava API use:
  // compile "com.coditory.sherlock:sherlock-api-rxjava:0.2.1"
}
```
