...
import static com.coditory.distributed.lock.reactive.ReactorTestableLocksWrapper.testableLocks

trait UsesReactorMongoDistributedLocks implements DistributedLocksCreator {
