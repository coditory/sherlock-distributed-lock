...
/**
 * Migration mechanism based on {@link ReactorSherlock} distributed locks.
 * <p>
 ...
 * </ul>
 */
public final class ReactorMigrator {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final List<MigrationChangeSet> migrationChangeSets;
    private final ReactorDistributedLock migrationLock;

    ReactorMigrator(@NotNull ReactorDistributedLock migrationLock, @NotNull List<MigrationChangeSet> migrationChangeSets) {
    ...
    static class MigrationChangeSet {
        ...
        MigrationChangeSet(String id, ReactorDistributedLock lock, Supplier<Mono<?>> action) {
            this.id = id;
            this.lock = lock;
            this.action = action;
        }
