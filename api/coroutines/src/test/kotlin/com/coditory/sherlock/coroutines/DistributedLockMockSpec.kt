...
class DistributedLockMockSpec {
    ...
    @TestFactory
    fun `should create single state lock with`() = listOf<TestTuple3<Boolean, Boolean, () -> DistributedLock>>(
    ...
    @TestFactory
    fun `should create a released in-memory lock`() = listOf<TestTuple1<() -> DistributedLock>>(
    ...
    @TestFactory
    fun `should create an acquired reentrant in-memory lock`() = listOf<TestTuple1<() -> DistributedLock>>(
    ...
    @TestFactory
    fun `should create an acquired single entrant in-memory lock`() = listOf<TestTuple1<() -> DistributedLock>>(
