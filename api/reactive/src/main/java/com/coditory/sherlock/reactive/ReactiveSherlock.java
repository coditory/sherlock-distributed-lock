...
public interface ReactiveSherlock {
  ...
  /**
   * Create distributed lock. Lock expires after {@link ReactiveSherlock#getLockDuration()}.
   *
  ...
  /**
   * Create distributed reentrant lock. Lock expires after {@link ReactiveSherlock#getLockDuration()}.
   *
   * @param lockId - the lock id
