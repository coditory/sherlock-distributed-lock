...
class KtDistributedLockMock private constructor(
    ...
    companion object {
        @JvmOverloads
        fun releasedInMemoryLock(lockId: String = UuidGenerator.uuid()): KtDistributedLockMock {
            Preconditions.expectNonEmpty(lockId, "lockId")
            return inMemoryLock(lockId, false)
        }

        @JvmOverloads
        fun acquiredInMemoryLock(lockId: String = UuidGenerator.uuid()): KtDistributedLockMock {
            Preconditions.expectNonEmpty(lockId, "lockId")
        ...
        @JvmOverloads
        fun releasedReentrantInMemoryLock(lockId: String = UuidGenerator.uuid()): KtDistributedLockMock {
            Preconditions.expectNonEmpty(lockId, "lockId")
            return reentrantInMemoryLock(lockId, false)
        }

        @JvmOverloads
        fun acquiredReentrantInMemoryLock(lockId: String = UuidGenerator.uuid()): KtDistributedLockMock {
            Preconditions.expectNonEmpty(lockId, "lockId")
        ...
        fun lockStub(result: Boolean): KtDistributedLockMock {
        ...
        private fun of(lock: KtDistributedLock): KtDistributedLockMock {
            Preconditions.expectNonNull(lock, "lock")
            return KtDistributedLockMock(lock)
        }
    }
}