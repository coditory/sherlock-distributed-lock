...
import com.coditory.sherlock.coroutines.KtDistributedLockMock.Companion.acquiredInMemoryLock
import com.coditory.sherlock.coroutines.KtDistributedLockMock.Companion.acquiredReentrantInMemoryLock
import com.coditory.sherlock.coroutines.KtDistributedLockMock.Companion.lockStub
import com.coditory.sherlock.coroutines.KtDistributedLockMock.Companion.releasedInMemoryLock
import com.coditory.sherlock.coroutines.KtDistributedLockMock.Companion.releasedReentrantInMemoryLock
import com.coditory.sherlock.coroutines.KtDistributedLockMock.Companion.sequencedLock
...
class KtDistributedLockMockSpec {
    ...
    fun `should create single state lock with`() =
        listOf<TestTuple3<Boolean, Boolean, () -> KtDistributedLock>>(
    ...
    fun `should create a released in-memory lock`() =
        listOf<TestTuple1<() -> KtDistributedLock>>(
