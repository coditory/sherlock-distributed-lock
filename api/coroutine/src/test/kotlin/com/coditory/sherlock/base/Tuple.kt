...
fun <T1, T2> tuple(p1: T1, p2: T2) = Tuple2(p1, p2)

fun <T1, T2, T3> tuple(p1: T1, p2: T2, p3: T3) = Tuple3(p1, p2, p3)

fun <T1, T2, T3, T4> tuple(p1: T1, p2: T2, p3: T3, p4: T4) = Tuple4(p1, p2, p3, p4)

fun <T1, T2, T3, T4, T5> tuple(p1: T1, p2: T2, p3: T3, p4: T4, p5: T5) = Tuple5(p1, p2, p3, p4, p5)
