...
/**
 * Migration mechanism based on {@link RxSherlock} distributed locks.
 * <p>
 ...
 * </ul>
 */
public final class RxMigrator {
    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final List<MigrationChangeSet> migrationChangeSets;
    private final RxDistributedLock migrationLock;

    RxMigrator(@NotNull RxDistributedLock migrationLock, @NotNull List<MigrationChangeSet> migrationChangeSets) {
    ...
    static class MigrationChangeSet {
        ...
        MigrationChangeSet(String id, RxDistributedLock lock, Supplier<Single<?>> action) {
            this.id = id;
            this.lock = lock;
            this.action = action;
        }
