...
public abstract class RxSherlockWithConnectorBuilder<T extends RxSherlockWithConnectorBuilder<?>> {
     ...
     */
    @NotNull
    public abstract RxSherlock build();

    protected RxSherlock build(RxDistributedLockConnector connector) {
        return new RxSherlockWithConnector(connector, ownerIdPolicy, duration);
    }
